...
![Installation ADDS étape 1](./assets/installation-ad-windows/windows-server-2025-install-adds-01-600x291.webp)

3.2.  **Choix du type d'installation.** Sélectionner l'installation basée sur un rôle ou une fonctionnalité.

![Installation ADDS étape 2](./assets/installation-ad-windows/windows-server-2025-install-adds-02-560x400.webp)

3.3.  **Sélection du serveur de destination.** Choisir le serveur local sur lequel déployer le rôle dans le pool de serveurs.

![Installation ADDS étape 3](./assets/installation-ad-windows/windows-server-2025-install-adds-03-559x400.webp)
...
![Installation ADDS étape 5](./assets/installation-ad-windows/windows-server-2025-install-adds-05-562x400.webp)
...
![Installation ADDS étape 6](./assets/installation-ad-windows/windows-server-2025-install-adds-06-558x400.webp)

3.6.  **Confirmation des sélections.** Passer les étapes intermédiaires, vérifier les options et confirmer l'installation.

![Installation ADDS étape 9](./assets/installation-ad-windows/windows-server-2025-install-adds-09-562x400.webp)
...
![Installation ADDS étape 10](./assets/installation-ad-windows/windows-server-2025-install-adds-10-557x400.webp)
